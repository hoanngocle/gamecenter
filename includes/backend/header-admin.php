                            ...
                            <div class="dropdown-menu dropdown-settings">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading">Béo Sagittarius</h4>
                                        <h5>Developer & Designer</h5>
                                    </div>
                                </div>
                                <hr />
                                <h5><strong>Personal Bio : </strong></h5>
                                I'm Sagittarius - D11CNPM4 - PTIT
                                <hr />
                                <center>
                                <a href="#" class="btn btn-info btn-sm">Full Profile</a>&nbsp; <a href="login_admin.php" class="btn btn-danger btn-sm">Logout</a>
                                </center>
                            </div>
                        </li>
                    </ul>
