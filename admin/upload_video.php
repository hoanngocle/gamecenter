                   		...
                   		<div class="panel-body" style="margin: 0 20px 0 20px">
							<form id="add_videos" action="" method="post" enctype="multipart/form-data">
								...
								<div class="form-group"  style="font-size: 18px" >
                                    ...
                                    <input style="font-size: 18px; height: 44px;" type="text" class="form-control" id="url" name="url" placeholder="<?= $lang['ADD_VIDEO_FORM_URL_REQUIRED'] ?>" value="<?php if(isset($url)) echo $url ?>" />
                                    <br>
                                    <center>
                                ...
                                ?>
								<div class="form-group"  style="font-size: 18px" >
                                    <label for="title"><?= $lang['ADD_VIDEO_FORM_ID_VIDEO'] ?></label>
                                ...
                                <!-- ================= Video [start] =================== -->
								<div class="form-group"  style="font-size: 18px" >
								   	<label for="title"><?= $lang['ADD_VIDEO_FORM_VIDEO'] ?></label>
                                ...
                                <!-- ================= Thumbnail [start] =================== -->
								<div class="form-group"  style="font-size: 18px" >
								   	<label for="title"><?= $lang['ADD_VIDEO_FORM_THUMBNAIL']?></label>
                                    <br>
