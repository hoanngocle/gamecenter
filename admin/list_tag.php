...
?>
	...
	<div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-head-line">List Tag</h1>
                </div>
            </div>
    ...
    <!-- ============================== Table News [start] ============================== -->
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h2 style="text-align: center">List Tag </h2>
                            <h4 style="text-align: center" ><a href="index.php">Home</a> / <a href="add_tag.php">Add Tag</a></h4>
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" style="text-align:center">
                                    <thead style="text-align:center">
                                        <tr>
							    			...
							    			<th style="width: 20% ; text-align:center">Keyword</th>
                                        </tr>
                                    </thead>
